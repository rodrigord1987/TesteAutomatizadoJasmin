...
describe("O serviço UserService", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({ //método especifico pra prover as dependências da classe que vamos testar. Usar só que a classe que vamos testar, tiver muitas dependencias no constructor #lentidão
